...
__global__ void kernelSearch(const unsigned* pData, unsigned num, unsigned target, unsigned stride) {
...
int main(const int argc, const char* argv[]) {
	...
	kernelSearch << < dimGrid, dimBlock >> > (dev_vecData, num, targetValue, stride);
